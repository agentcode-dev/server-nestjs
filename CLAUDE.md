...
1. **AgentCode NestJS Docs** — The Docusaurus documentation site at `../docs/docs/server/nestjs/`:
   - Find the relevant page and update it.
   - If adding a new feature, create a new doc page or update an existing one.

2. **CLAUDE.md** (this file) — Update the features table if adding a new feature.

3. **README.md** — Update the feature summary table if adding a new feature.
